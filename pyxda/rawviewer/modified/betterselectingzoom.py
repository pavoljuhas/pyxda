...
from traits.api import Bool, Enum, Trait, Int, Float, Tuple, Instance, Property, List
...
class BetterSelectingZoom(AbstractOverlay, BetterZoom):
    ...
    def selecting_left_up(self, event):
        ...
        width = abs(event.x - self.xi)
        height = abs(event.y - self.yi)
        
        self.rHistory.append(self.ratio)
